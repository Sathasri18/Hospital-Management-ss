...
class  main extends JFrame implements ActionListener, Runnable
{
	...
	private final JButton loginBtn, exitBtn;
	...
	main()
	{
		...
		JLabel nameLbl = new JLabel("Hospital Managment ");
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		if(source.equals(loginBtn))
		{
			...
			{
				JOptionPane.showMessageDialog(null,"Invalid User name and password" , "WARNING!!!",JOptionPane.INFORMATION_MESSAGE);
				userTxt.setText("");
				passwordTxt.setText("");
			}				
	...
	protected void finalize()
	{
		try
		{
			DoctorInfoAdd.cn.close();
			Billing.cn.close();
			DoctorInfomodify.cn.close();
			DoctorInfoView.cn.close();
			DoctorTableFromDatabase.cn.close();
			PatientInfo.cn.close();
			PatientInfomodify.cn.close();
			PatientInfoView.cn.close();
			PatientTableFromDatabase.cn.close();
			Report.cn.close();
		} catch(Exception e)
		{
			System.out.println(e.getMessage());
